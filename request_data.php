    ...
    <div class="container">
      <div class="wrapper">
        ...
        <form action="request_data.php" method="post">
          <div class="row">
            <i class="fas fa-at"></i>
            <input type="text" placeholder="Book Name" value=" <?php echo $namebook['book_name'] ?>" name="issue_book" required>
            
          </div>
          <div class="row">
            <i class="fas fa-at"></i>
            <input type="text" placeholder="user_email" value="<?php echo $_SESSION["auth"][0]["email"] ?>" name="users" required>
          </div>
